housing_test <- read.csv("C:/Users/hp/OneDrive/Desktop/r/project 1/housing_test.csv")
View(housing_test)
housing_train <- read.csv("C:/Users/hp/OneDrive/Desktop/r/project 1/housing_train.csv")
View(housing_train)
library(dplyr)
